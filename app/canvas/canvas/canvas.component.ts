...
drawGraphLine(ax,ay,bx,by,color, size) {
  ...
  // newLine.setAttribute("id","line");
  // newLine.style.setProperty("height", length + "px");
  // newLine.style.setProperty("z-index", "2");
  // newLine.style.setProperty("width", 2 + "px");
  // newLine.style.backgroundColor = color;
  // newLine.style.setProperty("position", "absolute");
  // newLine.style.setProperty("top", (ay) + "px");
  // newLine.style.setProperty("left", (ax) + "px");
  // newLine.style.setProperty("transform","rotate(" + calc + "deg)");


 // newLine.style.setProperty("-ms-transform", "rotate(" + calc + "deg)");
 // newLine.style.setProperty("tranform-origin","0% 0%");
//  newLine.style.setProperty("-moz-transform","0% 0%");
//  newLine.style.setProperty("-moz-transform-origin","0% 0%");
//  newLine.style.setProperty("-webkit-transform","rotate(" + calc  + "deg)");
//  newLine.style.setProperty("-webkit-transform-origin","0% 0%");
//  newLine.style.setProperty("-o-transform","rotate(" + calc + "deg)");
//  newLine.style.setProperty("-o-transform-origin","0% 0%");

  // newLine.innerHTML += "<div style='height:" + length + ";z-index:2; px;width:1px;background-color:black;position:absolute;top:" + (x2) + "px;left:" + (x1) + "px;transform:rotate(" + calc + "deg);-ms-transform:rotate(" + calc + "deg);transform-origin:0% 0%;-moz-transform:rotate(" + calc + "deg);-moz-transform-origin:0% 0%;-webkit-transform:rotate(" + calc  + "deg);-webkit-transform-origin:0% 0%;-o-transform:rotate(" + calc + "deg);-o-transform-origin:0% 0%;'></div>";

 //document.getElementById("dropzone").appendChild(newLine);

// document.body.innerHTML += "<div id='line' style='height:" + length + "px;width:1px;background-color:black;position:absolute;top:" + (x2) + "px;left:" + (x1) + "px;transform:rotate(" + calc + "deg);-ms-transform:rotate(" + calc + "deg);transform-origin:0% 0%;-moz-transform:rotate(" + calc + "deg);-moz-transform-origin:0% 0%;-webkit-transform:rotate(" + calc  + "deg);-webkit-transform-origin:0% 0%;-o-transform:rotate(" + calc + "deg);-o-transform-origin:0% 0%;'></div>"
 ...
 // this.fun(this.lineX1, this.lineY1, this.lineX2,this.lineY2);
}
